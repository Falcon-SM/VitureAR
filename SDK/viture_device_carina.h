...
/**
 * @brief Reset origin with pose data in OpenGL coordinate system (x -> right, y -> up, z -> backward)
 * @param handle Handle to the XRDeviceProvider instance
 * @param pose 7 floats for position and quaternion: [px, py, pz, qw, qx, qy, qz]
 * @return VITURE_GLASSES_SUCCESS on success, error code on failure
 */
