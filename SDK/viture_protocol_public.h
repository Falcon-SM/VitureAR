 ...
 *         - VITURE_GLASSES_ERROR_USB_UNAVAILABLE USB not available
 *         - VITURE_GLASSES_ERROR_NOT_SUPPORTED   display mode not supported by device
 *         - VITURE_GLASSES_ERROR_USB_EXEC        USB execution error
 *         - VITURE_GLASSES_ERROR_UNKNOWN         other error
 */
 ...
 * @return VITURE_GLASSES_SUCCESS on success, or:
 *         - VITURE_GLASSES_ERROR_INVALID_PARAM   null handle or null output pointers
 *         - VITURE_GLASSES_ERROR_USB_UNAVAILABLE USB not available
 ...
 * @return VITURE_GLASSES_SUCCESS on success, or:
 *         - VITURE_GLASSES_ERROR_INVALID_PARAM   null handle or invalid values
 *         - VITURE_GLASSES_ERROR_USB_UNAVAILABLE USB not available
 *         - VITURE_GLASSES_ERROR_NOT_SUPPORTED   feature not supported by device
 *         - VITURE_GLASSES_ERROR_USB_EXEC        USB execution error
 *         - VITURE_GLASSES_ERROR_UNKNOWN         other error
...
/**
 * @brief Set the native DOF bypass mode.
 *
 * When bypass mode is enabled, the glasses disable native 3DOF tracking.
 * This function is only available on devices with native 3DOF support.
 *
 * The device may reject the command if the current display mode does not support
 * bypass mode. In that case, VITURE_GLASSES_ERROR_INVALID_STATE is returned and
 * out_current_display_mode (if non-null) is set to the current display mode value.
 *
 * @param handle Valid XRDeviceProvider handle.
 * @param enable 1 to enable bypass mode (disable native DOF tracking), 0 to disable.
 * @param out_current_display_mode Optional output parameter. Set to the current display
 *        mode when the device rejects the command due to an incompatible display mode.
 *        May be NULL.
 * @return VITURE_GLASSES_SUCCESS on success, or:
 *         - VITURE_GLASSES_ERROR_INVALID_PARAM   null handle
 *         - VITURE_GLASSES_ERROR_USB_UNAVAILABLE USB not available
 *         - VITURE_GLASSES_ERROR_NOT_SUPPORTED   feature not supported by device
 *         - VITURE_GLASSES_ERROR_USB_EXEC        USB execution error
 *         - VITURE_GLASSES_ERROR_INVALID_STATE   current display mode does not support
 *                                                bypass mode; out_current_display_mode
 *                                                is set to the current mode value
 *         - VITURE_GLASSES_ERROR_UNKNOWN         other error
 */
VITURE_API int xr_device_provider_native_dof_set_bypass_mode(XRDeviceProviderHandle handle,
                                                              int enable,
                                                              int* out_current_display_mode);

/**
 * @brief Get the current native DOF bypass mode.
 *
 * This function is only available on devices with native 3DOF support.
 *
 * @param handle Valid XRDeviceProvider handle.
 * @return 0 if bypass mode is disabled, 1 if bypass mode is enabled, or a negative error code:
 *         - VITURE_GLASSES_ERROR_INVALID_PARAM   null handle
 *         - VITURE_GLASSES_ERROR_USB_UNAVAILABLE USB not available
 *         - VITURE_GLASSES_ERROR_NOT_SUPPORTED   feature not supported by device
 *         - VITURE_GLASSES_ERROR_USB_EXEC        USB execution error
 ...
 *         - VITURE_GLASSES_ERROR_UNKNOWN         other error
 */
VITURE_API int xr_device_provider_native_dof_get_bypass_mode(XRDeviceProviderHandle handle);
